...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cq9hpino1ahr.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'mesutblog' # please enter your s3 bucket name
